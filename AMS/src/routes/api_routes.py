...
def view_message2():
    ...
    print(
        'SELECT "fromi_d","message","date","chat_id" FROM "chat" WHERE "chat_id">%s AND (("to_id"=%s AND  "from_id"=%s) OR ("to_id"=%s AND "from_id"=%s)  )  ORDER BY chat_id ASC'
    )

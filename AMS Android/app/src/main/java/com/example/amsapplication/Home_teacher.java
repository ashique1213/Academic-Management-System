                ...
                ald.setTitle("choose")
                        .setPositiveButton(" add actualplan", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                try
                                {
                                    ...
                                    String url1="http://"+sh.getString("ip","")+":5000/api/addactualplan?id="+sh.getString("lid","")+"";
                        ...
                        .setNegativeButton(" add proposedplan ", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                String url3="http://"+sh.getString("ip","")+":5000/api/addproposedplan?id="+sh.getString("lid","")+"";

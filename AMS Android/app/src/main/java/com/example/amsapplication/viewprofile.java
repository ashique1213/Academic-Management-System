...
//                        Toast.makeText(STDviewprofile.this, "fdff"+response, Toast.LENGTH_SHORT).show();
                        ...
                        e2.setText(jo.getString("qualification"));

                        e4.setText(jo.getString("gender"));
                        e5.setText(jo.getString("designation"));
                        e6.setText(jo.getString("age"));
...
//        i2.setImageDrawable(Drawable.createFromPath(getIntent().getStringExtra("photo"))));
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent ii=new Intent(getApplicationContext(),editdptea.class);
                startActivity(ii);
...
//                                edp.commit();
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        params.put("quali", addno);
                        params.put("gen", gender);
                        params.put("des", dob);
                        params.put("ph", phone);
                        params.put("age", address);
                        params.put("lid", sh.getString("lid",""));

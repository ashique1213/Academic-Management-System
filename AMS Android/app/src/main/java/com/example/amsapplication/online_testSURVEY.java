...
public class online_testSURVEY extends AppCompatActivity {
    TextView tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url ="http://"+sh.getString("ip", "") + ":5000/api/get_questionsurvey";
...
//                    photo=new ArrayList<>();
                    for(int i=0;i<ar.length();i++)
                    {
                        ...
                        question.add(jo.getString("survey questions"));
...
//                    l1.setOnItemClickListener(viewuser.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(online_testSURVEY.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
...
//                Toast.makeText(getApplicationContext(), ansText, Toast.LENGTH_SHORT).show();
                if (ansText.equals(answer.get(flag))) {
                    ...
                    e1.commit();
                    String url = "http://" + sh.getString("ip", "") + ":5000/api/answertestsurvey";

...
public class customforviewstudent extends BaseAdapter {
    ...
    public customforviewstudent(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c,ArrayList<String> D,ArrayList<String> E,ArrayList<String> f,ArrayList<String> g,ArrayList<String> h,ArrayList<String> i) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_customforviewstudent, null);
        ...
        TextView tv6=(TextView)gridView.findViewById(R.id.textView6);
        TextView tv7=(TextView)gridView.findViewById(R.id.textView7);
        TextView tv8=(TextView)gridView.findViewById(R.id.textView8);

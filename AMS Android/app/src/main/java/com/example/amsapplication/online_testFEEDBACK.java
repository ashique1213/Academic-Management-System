...
//                            radio_g.clearCheck();
                                if (res.equalsIgnoreCase("success")) {
                                    ...
                                    Toast.makeText(online_testFEEDBACK.this, "already attended ", Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(getApplicationContext(), "(((***:"+flag+":"+question.size(), Toast.LENGTH_SHORT).show();
                ...
                if (flag < question.size()) {
                    ...
                    Toast.makeText(getApplicationContext(), "feedback finished...", Toast.LENGTH_SHORT).show();
                    marks=correct;

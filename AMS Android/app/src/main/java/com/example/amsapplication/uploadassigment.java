...
public class uploadassigment extends AppCompatActivity {
    Button b1,b2;
    EditText e1;
    String PathHolder = "";
    byte[] filedt = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_uploadassigment);
...
//            intent.setType("application/pdf");
    ...
    private void uploadBitmap(final String title) {
        pd=new ProgressDialog(uploadassigment.this);
...
//                        Toast.makeText(Upload_agreement.this, "Report Sent Successfully", Toast.LENGTH_LONG).show();
                            if (obj.getString("task").equalsIgnoreCase("success")) {
                                ...
                                Toast.makeText(uploadassigment.this, "Successfully uploaded", Toast.LENGTH_LONG).show();

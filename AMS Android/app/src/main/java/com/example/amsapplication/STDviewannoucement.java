...
//                    Toast.makeText(STDviewannoucement.this, "jj"+response, Toast.LENGTH_SHORT).show();
                    ...
                    for(int i=0;i<ar.length();i++)
                    {
                        ...
                        Ancment.add(jo.getString("anouncement"));
...
//                    l1.setOnItemClickListener(viewuser.this);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(STDviewannoucement.this, "err"+error, Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
